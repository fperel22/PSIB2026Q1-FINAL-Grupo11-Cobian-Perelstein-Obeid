...
def segment_chan_vese_roi(
    ...
    # La lesion esperada suele ser hipoecoica. Si el resultado seleccionado
    # queda mas claro que el exterior, se invierte dentro del ROI.
    ...
    def segment_current_image(self) -> None:
        ...
        try:
            if method == "Region growing":
                ...
                predicted = segment_region_growing(segmentation_image, self.roi_rect, self.seed_xy, tolerance)
                parameters = {
                ...
                predicted = segment_local_threshold(segmentation_image, self.roi_rect, mode)
                parameters = {
