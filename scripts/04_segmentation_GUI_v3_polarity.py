...
class SegmentationGUI(QMainWindow):
    ...
    def _update_method_presets(self) -> None:
        ...
        if method == "Region growing":
            ...
            self.preset_combo.addItem("Percentil 70", {"mode": "percentile_70"})
        ...
        try:
            if method == "Region growing":
                ...
                parameters = {
                    ...
                    "postprocessing": "ROI + closing 7x7 + fill holes + opening 3x3 + seed component",
                }
            elif method == "Umbral local":
                ...
                parameters = {
                    ...
                    "lesion_polarity": lesion_polarity,
                    "segmentation_image": enhancement_mode,
                    "postprocessing": "ROI + closing 7x7 + fill holes + opening 3x3 + largest component",
                }
            elif method == "Chan-Vese":
                ...
                parameters = {
                    ...
                    "postprocessing": "ROI + closing 5x5 + fill holes + opening 3x3 + largest component",
                }
            else:
